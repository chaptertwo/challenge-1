...
--just realized this table is probably pointless since inventory is doing the same thing..
--SET IDENTITY_INSERT BinProduct ON
--INSERT INTO BinProduct(BinId, ProductId)
--VALUES (1, 1), (1, 2), (3, 1), (2, 2), (3, 3)
--SET IDENTITY_INSERT BinProduct OFF
